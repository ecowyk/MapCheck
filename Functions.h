...
double segmentLength(Line l);//线段长度

double pointToSegmentDistance(AIReal x,AIReal y,Line l);//点到线段距离

double shortestDistanceBetweenPolylines(MyPath polyline1,MyPath polyline2);//折线间最短距离
